...
function AbsenceFlow({ nav, store }) {
  ...
  if (done) {
    ...
    return <Success
      ...
      lines={[
        ...
        noImpact
          ? { text: typeId === "vacation" ? "Your pay is not affected – holiday pay is paid as usual." : "Your pay is not affected by this absence.", icon: "wallet" }
  ...
  if (cur === "type") {
    ...
    }[typeId] || (impact && impact.amount === 0
      ? "This absence does not affect your net pay."
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <Card pad={0}>
          <div style={{ padding: "4px 16px" }}>
            ...
            <SummaryRow label="Pay impact" value={impact.amount === 0 ? (typeId === "vacation" ? "None (holiday pay)" : "None") : kr(impact.amount)} tone={impact.amount === 0 ? undefined : "danger"} last />
          </div>
        </Card>
